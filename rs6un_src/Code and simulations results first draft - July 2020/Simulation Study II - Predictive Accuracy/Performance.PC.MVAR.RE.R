Performance.PC.MVAR.RE = function(N,n,T,t,Q,q,e,R,P){
...
load(file = paste("MSE_PC_VAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",1,"_R_",r,".RData",sep = ""))

MSE.PC.VAR.list.nComp.1[r,p] = unlist(MSE.PC.VAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 2 component
load(file = paste("MSE_PC_VAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",2,"_R_",r,".RData",sep = ""))

MSE.PC.VAR.list.nComp.2[r,p] = unlist(MSE.PC.VAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 3 component
load(file = paste("MSE_PC_VAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",3,"_R_",r,".RData",sep = ""))

MSE.PC.VAR.list.nComp.3[r,p] = unlist(MSE.PC.VAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 4 component
load(file = paste("MSE_PC_VAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",4,"_R_",r,".RData",sep = ""))

MSE.PC.VAR.list.nComp.4[r,p] = unlist(MSE.PC.VAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 5 component
load(file = paste("MSE_PC_VAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",5,"_R_",r,".RData",sep = ""))

MSE.PC.VAR.list.nComp.5[r,p] = unlist(MSE.PC.VAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 6 component
load(file = paste("MSE_PC_VAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",6,"_R_",r,".RData",sep = ""))
...
# Load PC-VAR with 1 component
load(file = paste("MSE_PC_MAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",1,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.FE.list.nComp.1[r,p] = unlist(MSE.PC.MAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 2 component
load(file = paste("MSE_PC_MAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",2,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.FE.list.nComp.2[r,p] = unlist(MSE.PC.MAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 3 component
load(file = paste("MSE_PC_MAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",3,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.FE.list.nComp.3[r,p] = unlist(MSE.PC.MAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 4 component
load(file = paste("MSE_PC_MAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",4,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.FE.list.nComp.4[r,p] = unlist(MSE.PC.MAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 5 component
load(file = paste("MSE_PC_MAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",5,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.FE.list.nComp.5[r,p] = unlist(MSE.PC.MAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 6 component
load(file = paste("MSE_PC_MAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",6,"_R_",r,".RData",sep = ""))
...
# Load PC-VAR with 1 component
load(file = paste("MSE_PC_MAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",1,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.RE.list.nComp.1[r,p] = unlist(MSE.PC.MAR.RE.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 2 component
load(file = paste("MSE_PC_MAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",2,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.RE.list.nComp.2[r,p] = unlist(MSE.PC.MAR.RE.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 3 component
load(file = paste("MSE_PC_MAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",3,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.RE.list.nComp.3[r,p] = unlist(MSE.PC.MAR.RE.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 4 component
load(file = paste("MSE_PC_MAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",4,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.RE.list.nComp.4[r,p] = unlist(MSE.PC.MAR.RE.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 5 component
load(file = paste("MSE_PC_MAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",5,"_R_",r,".RData",sep = ""))

MSE.PC.MAR.RE.list.nComp.5[r,p] = unlist(MSE.PC.MAR.RE.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 6 component
load(file = paste("MSE_PC_MAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",6,"_R_",r,".RData",sep = ""))
...
# Load PC-VAR with 2 component
load(file = paste("MSE_PC_MVAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",2,"_R_",r,".RData",sep = ""))

MSE.PC.MVAR.FE.list.nComp.2[r,p] = unlist(MSE.PC.MVAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 3 component
load(file = paste("MSE_PC_MVAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",3,"_R_",r,".RData",sep = ""))

MSE.PC.MVAR.FE.list.nComp.3[r,p] = unlist(MSE.PC.MVAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 4 component
load(file = paste("MSE_PC_MVAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",4,"_R_",r,".RData",sep = ""))

MSE.PC.MVAR.FE.list.nComp.4[r,p] = unlist(MSE.PC.MVAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 5 component
load(file = paste("MSE_PC_MVAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",5,"_R_",r,".RData",sep = ""))

MSE.PC.MVAR.FE.list.nComp.5[r,p] = unlist(MSE.PC.MVAR.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 6 component
load(file = paste("MSE_PC_MVAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",6,"_R_",r,".RData",sep = ""))
...
# Load PC-VAR with 2 component
load(file = paste("MSE_PC_MVAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",2,"_R_",r,".RData",sep = ""))

MSE.PC.MVAR.RE.list.nComp.2[r,p] = unlist(MSE.PC.MVAR.RE.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 3 component
load(file = paste("MSE_PC_MVAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",3,"_R_",r,".RData",sep = ""))

MSE.PC.MVAR.RE.list.nComp.3[r,p] = unlist(MSE.PC.MVAR.RE.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 4 component
load(file = paste("MSE_PC_MVAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",4,"_R_",r,".RData",sep = ""))

MSE.PC.MVAR.RE.list.nComp.4[r,p] = unlist(MSE.PC.MVAR.RE.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 5 component
load(file = paste("MSE_PC_MVAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",5,"_R_",r,".RData",sep = ""))

MSE.PC.MVAR.RE.list.nComp.5[r,p] = unlist(MSE.PC.MVAR.RE.Sys$MSE.Sys.MVAR[p])

# Load PC-VAR with 6 component
load(file = paste("MSE_PC_MVAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",6,"_R_",r,".RData",sep = ""))
...
load(file = paste("MSE_MVAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))
...
load(file = paste("MSE_AR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))

MSE.AR.list[r,p] = unlist(MSE.AR.Sys.PC$MSE.Sys.AR[p])

# VAR model on scale original data 
load(file = paste("MSE_VAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))
