...
# Save Psi matrix
save(Psi.list, file = paste("Psi_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_R_",r,".RData",sep = ""))

for (e in 1:length(var.E)){
# Monte Carlo replicates
Sim.Var.Data = Data.PC.VAR(N[n],T[t],P,Psi.list,cor.Sigma,var.Psi,var.E[e])
 
# Save datasets
save(Sim.Var.Data, file = paste("Data_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))
}}}}}
...
save(data.list, file = paste("Data_Block_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))

for (p in 1:P){
data.list.PC = data.block.PC(data.list,nComp=p,fold)

# Save datasets
save(data.list.PC, file = paste("Data_Block_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",p,"_R_",r,".RData",sep = ""))
}}}}}}
...
load(file = paste("Data_Block_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",p,"_R_",r,".RData",sep = ""))

MSE.MVAR.Sys.PC = MSE.Sys(data.list.PC,P)
MSE.VAR.Sys.PC = MSE.VAR.Sys(data.list.PC,P)
MSE.AR.Sys.PC = MSE.AR.Sys(data.list.PC,P)

save(MSE.MVAR.Sys.PC, file = paste("MSE_MVAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))
save(MSE.VAR.Sys.PC, file = paste("MSE_VAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))
save(MSE.AR.Sys.PC, file = paste("MSE_AR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))
}}}}}
...
# Load training and testing set
load(file = paste("Data_Block_PC_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",p,"_R_",r,".RData",sep = ""))
...
save(MSE.PC.VAR.Sys, file = paste("MSE_PC_VAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",p,"_R_",r,".RData",sep = ""))
save(MSE.PC.MAR.Sys, file = paste("MSE_PC_MAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",p,"_R_",r,".RData",sep = ""))
save(MSE.PC.MAR.RE.Sys, file = paste("MSE_PC_MAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",p,"_R_",r,".RData",sep = ""))
...
save(MSE.PC.MVAR.Sys, file = paste("MSE_PC_MVAR_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",p,"_R_",r,".RData",sep = ""))
save(MSE.PC.MVAR.RE.Sys, file = paste("MSE_PC_MVAR_RE_PC_MVAR_RE_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",p,"_R_",r,".RData",sep = ""))
}}}}}}}
