Performance.VAR = function(N,n,T,t,P,p,K,k,diff,d,size,s,R){
...
load(file = paste("MSE_MVAR_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
...
load(file = paste("MSE_AR_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
"_Diff_",diff[d],"_size_",size[s],"_R_",r,".RData",sep = ""))

MSE.AR.list[r] = unlist(MSE.AR.PS.Sys$MSE)

load(file = paste("MSE_VAR_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
"_Diff_",diff[d],"_size_",size[s],"_R_",r,".RData",sep = ""))
