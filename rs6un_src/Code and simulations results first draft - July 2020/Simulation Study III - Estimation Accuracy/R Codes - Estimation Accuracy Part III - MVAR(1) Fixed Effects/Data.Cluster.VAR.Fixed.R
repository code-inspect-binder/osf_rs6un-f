...
Data.Cluster.VAR.Fixed = function(N,T,K,size,Psi,cor.Sigma){
...
return(list(Sigma.Psi=NULL,Psi=Psi,Psi.i=Psi.list,lambda.max.list=NULL,data=data,Cluster=Cluster))
}