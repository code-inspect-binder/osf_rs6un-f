...
Performance.MVAR.RE = function(N,n,T,t,P,p,R){
...
load(file = paste("MSE_MVAR_MVAR_RE_N_",N[n],"_T_",T[t],"_P_",P[p],"_R_",r,".RData",sep = ""))
...
load(file = paste("MSE_AR_MVAR_RE_N_",N[n],"_T_",T[t],"_P_",P[p],"_R_",r,".RData",sep = ""))
MSE.AR.list[[w]][r] = unlist(MSE.AR.PS.Sys$MSE.Sys.AR[w])

load(file = paste("MSE_VAR_MVAR_RE_N_",N[n],"_T_",T[t],"_P_",P[p],"_R_",r,".RData",sep = ""))
