...
# Save Psi matrix
save(Psi.list, file = paste("Psi_Cluster_MVAR_RE_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
...
# Save datasets
save(Sim.Var.Data, file = paste("Data_Cluster_MVAR_RE_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
...
# Generate training and testing set
load(file = paste("Data_Cluster_MVAR_RE_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
"_Diff_",diff[d],"_size_",size[s],"_R_",r,".RData",sep = ""))

data.list = data.block(Sim.Var.Data$data,fold)

# Save datasets
save(data.list, file = paste("Data_Block_Cluster_MVAR_RE_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
"_Diff_",diff[d],"_size_",size[s],"_R_",r,".RData",sep = ""))
}}}}}}}
...
load(file = paste("Data_Block_Cluster_MVAR_RE_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
"_Diff_",diff[d],"_size_",size[s],"_R_",r,".RData",sep = ""))

MSE.MVAR.PS.Sys = MSE.Sys(data.list,P[p])

save(MSE.MVAR.PS.Sys, file = paste("MSE_MVAR_Cluster_MVAR_RE_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
"_Diff_",diff[d],"_size_",size[s],"_R_",r,".RData",sep = ""))
...
save(MSE.VAR.PS.Sys, file = paste("MSE_VAR_Cluster_MVAR_RE_N_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
"_Diff_",diff[d],"_size_",size[s],"_R_",r,".RData",sep = ""))
...
save(MSE.AR.PS.Sys, file = paste("MSE_AR_Cluster_MVAR_RE_N_N_",N[n],"_T_",T[t],"_P_",P[p],"_K_",K[k],
"_Diff_",diff[d],"_size_",size[s],"_R_",r,".RData",sep = ""))
}}}}}}}
