...
Data.PS.VAR = function(N,T,Psi,cor.Sigma){
...
# Simulate person-specific VAR(1) model

lambda.max.list = list()
Psi.list = list()
...
return(list(Sigma.Psi=NULL,Psi=Psi,Psi.i=Psi.list,lambda.max.list=lambda.max.list,data=data))
}
