---
title: "Simulation results person-specific VAR(1) model with random effects"
...
save(RM.Anova.MSE.Psi.AR, file = 'Results_Performance_MSE_Psi_AR_PS_VAR.RData')

load(file = 'Results_Performance_MSE_Psi_AR_PS_VAR.RData')
...
save(RM.Anova.MSE.Psi.CR, file = 'Results_Performance_MSE_Psi_CR_PS_VAR.RData')

load(file = 'Results_Performance_MSE_Psi_CR_PS_VAR.RData')
...
#save(RM.Anova.95CR.Psi.AR, file = 'Results_Performance_95CR_Psi_AR_PS_VAR.RData')

load(file = 'Results_Performance_95CR_Psi_AR_PS_VAR.RData')
...
#save(RM.Anova.95CR.Psi.CR, file = 'Results_Performance_95CR_Psi_CR_PS_VAR.RData')

load(file = 'Results_Performance_95CR_Psi_CR_PS_VAR.RData')
...
```{r}
Boxplot_MSE_Psi_AR_PS_VAR_Variables = ggplot(Performance.MSE.AR.Mean, aes(x=as.factor(Variables), y=MSE.Psi, fill = Model)) + 
...
Boxplot_MSE_Psi_AR_PS_VAR_Variables

ggsave("Boxplot_MSE_Psi_AR_PS_VAR_Variables.png", width = 6, height = 4)
...
```{r}
Boxplot_MSE_Psi_AR_PS_VAR_Time = ggplot(Performance.MSE.AR.Mean, aes(x=as.factor(Time), y=MSE.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "MSE autoregressive effects", x="Number of time points")
Boxplot_MSE_Psi_AR_PS_VAR_Time

ggsave("Boxplot_MSE_Psi_AR_PS_VAR_Time.png", width = 6, height = 4)
...
```{r}
Boxplot_MSE_Psi_AR_PS_VAR_Persons = ggplot(Performance.MSE.AR.Mean, aes(x=as.factor(Persons), y=MSE.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "MSE autoregressive effects", x="Number of persons")
Boxplot_MSE_Psi_AR_PS_VAR_Persons

ggsave("Boxplot_MSE_Psi_AR_PS_VAR_Persons.png", width = 6, height = 4)
...
```{r}
Boxplot_MSE_Psi_CR_PS_VAR_Variables = ggplot(Performance.MSE.CR.Mean, aes(x=as.factor(Variables), y=MSE.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "MSE cross-regressive effects", x="Number of variables")
Boxplot_MSE_Psi_CR_PS_VAR_Variables

ggsave("Boxplot_MSE_Psi_CR_PS_VAR_Variables.png", width = 6, height = 4)
...
```{r}
Boxplot_MSE_Psi_CR_PS_VAR_Time = ggplot(Performance.MSE.CR.Mean, aes(x=as.factor(Time), y=MSE.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "MSE cross-regressive effects", x="Number of time points")
Boxplot_MSE_Psi_CR_PS_VAR_Time

ggsave("Boxplot_MSE_Psi_CR_PS_VAR_Time.png", width = 6, height = 4)
...
```{r}
Boxplot_MSE_Psi_CR_PS_VAR_Persons = ggplot(Performance.MSE.CR.Mean, aes(x=as.factor(Persons), y=MSE.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "MSE cross-regressive effects", x="Number of persons")
Boxplot_MSE_Psi_CR_PS_VAR_Persons

ggsave("Boxplot_MSE_Psi_CR_PS_VAR_Persons.png", width = 6, height = 4)
...
```{r}
Boxplot_95CR_Psi_AR_PS_VAR_Variables = ggplot(Performance.95CR.AR.Mean, aes(x=as.factor(Variables), y=CR.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "95% Coverage rate autoregressive effects", x="Number of variables")
Boxplot_95CR_Psi_AR_PS_VAR_Variables

ggsave("Boxplot_95CR_Psi_AR_PS_VAR_Variables.png", width = 6, height = 4)
...
```{r}
Boxplot_95CR_Psi_AR_PS_VAR_Time = ggplot(Performance.95CR.AR.Mean, aes(x=as.factor(Time), y=CR.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "95% Coverage rate autoregressive effects", x="Number of time points")
Boxplot_95CR_Psi_AR_PS_VAR_Time

ggsave("Boxplot_95CR_Psi_AR_PS_VAR_Time.png", width = 6, height = 4)
...
```{r}
Boxplot_95CR_Psi_AR_PS_VAR_Persons = ggplot(Performance.95CR.AR.Mean, aes(x=as.factor(Persons), y=CR.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "95% Coverage rate autoregressive effects", x="Number of persons")
Boxplot_95CR_Psi_AR_PS_VAR_Persons

ggsave("Boxplot_95CR_Psi_AR_PS_VAR_Persons.png", width = 6, height = 4)
...
```{r}
Boxplot_95CR_Psi_CR_PS_VAR_Variables = ggplot(Performance.95CR.CR.Mean, aes(x=as.factor(Variables), y=CR.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "95% Coverage rate cross-regressive effects", x="Number of variables")
Boxplot_95CR_Psi_CR_PS_VAR_Variables

ggsave("Boxplot_95CR_Psi_CR_PS_VAR_Variables.png", width = 6, height = 4)
...
```{r}
Boxplot_95CR_Psi_CR_PS_VAR_Time = ggplot(Performance.95CR.CR.Mean, aes(x=as.factor(Time), y=CR.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "95% Coverage rate cross-regressive effects", x="Number of time points")
Boxplot_95CR_Psi_CR_PS_VAR_Time

ggsave("Boxplot_95CR_Psi_CR_PS_VAR_Time.png", width = 6, height = 4)
...
```{r}
Boxplot_95CR_Psi_CR_PS_VAR_Persons = ggplot(Performance.95CR.CR.Mean, aes(x=as.factor(Persons), y=CR.Psi, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "95% Coverage rate cross-regressive effects", x="Number of persons")
Boxplot_95CR_Psi_CR_PS_VAR_Persons

ggsave("Boxplot_95CR_Psi_CR_PS_VAR_Persons.png", width = 6, height = 4)
