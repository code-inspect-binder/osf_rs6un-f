---
title: "Simulation results predictive performance person-specific VAR(1) model"
...
#save(RM.Anova.MSPE, file = 'Results_Performance_MSPE_VAR.RData')

load(file = 'Results_Performance_MSPE_VAR.RData')
...
#save(RM.Anova.R2, file = 'Results_Performance_R2_VAR.RData')

load(file = 'Results_Performance_R2_VAR.RData')
...
Boxplot_MSPE_VAR_Time_Variables = ggplot(Performance.MSPE.Mean.Model, aes(x=interaction(Time,Variables), y=MSPE, fill = Model)) + 
...
Boxplot_MSPE_VAR_Time_Variables

ggsave("Boxplot_MSPE_VAR_Time_Variables.png", width = 6, height = 4)
```
...
```{r}
Boxplot_MSPE_VAR_P_2_Time = ggplot(Performance.MSPE.Mean.P2, aes(x=as.factor(Time), y=MSPE, fill = Model)) + 
...
Boxplot_MSPE_VAR_P_2_Time

ggsave("Boxplot_MSPE_VAR_P_2_Time.png", width = 6, height = 4)
...
```{r}
Boxplot_MSPE_VAR_P_2_Persons = ggplot(Performance.MSPE.Mean.P2, aes(x=as.factor(Persons), y=MSPE, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() +
labs(y = "MSPE", x="Number of persons")
Boxplot_MSPE_VAR_P_2_Persons

ggsave("Boxplot_MSPE_VAR_P_2_Persons.png", width = 6, height = 4)
...
```{r}
Boxplot_R2_VAR_P_2_Time = ggplot(Performance.R2.Mean.P2, aes(x=as.factor(Time), y=R2, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "R2", x="Number of time points")
Boxplot_R2_VAR_P_2_Time

ggsave("Boxplot_R2_VAR_P_2_Time.png", width = 6, height = 4)
```

##### Across the number of persons

```{r}
Boxplot_R2_VAR_P_2_Persons = ggplot(Performance.R2.Mean.P2, aes(x=as.factor(Persons), y=R2, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() +
labs(y = "R2", x="Number of persons")
Boxplot_R2_VAR_P_2_Persons

ggsave("Boxplot_R2_VAR_P_2_Persons.png", width = 6, height = 4)
```
...
```{r}
Boxplot_MSPE_VAR_P_4_Time = ggplot(Performance.MSPE.Mean.P4, aes(x=as.factor(Time), y=MSPE, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "MSPE", x="Number of time points")
Boxplot_MSPE_VAR_P_4_Time

ggsave("Boxplot_MSPE_VAR_P_4_Time.png", width = 6, height = 4)
...
```{r}
Boxplot_MSPE_VAR_P_4_Persons = ggplot(Performance.MSPE.Mean.P4, aes(x=as.factor(Persons), y=MSPE, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() +
labs(y = "MSPE", x="Number of persons")
Boxplot_MSPE_VAR_P_4_Persons
...
```{r}
Boxplot_R2_VAR_P_4_Time = ggplot(Performance.R2.Mean.P2, aes(x=as.factor(Time), y=R2, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "R2", x="Number of time points")
Boxplot_R2_VAR_P_4_Time

ggsave("Boxplot_R2_VAR_P_4_Time.png", width = 6, height = 4)
```

##### Across the number of persons

```{r}
Boxplot_R2_VAR_P_4_Persons = ggplot(Performance.R2.Mean.P4, aes(x=as.factor(Persons), y=R2, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() +
labs(y = "R2", x="Number of persons")
Boxplot_R2_VAR_P_4_Persons

ggsave("Boxplot_R2_VAR_P_4_Persons.png", width = 6, height = 4)
```
...
```{r}
Boxplot_MSPE_VAR_P_8_Time = ggplot(Performance.MSPE.Mean.P8, aes(x=as.factor(Time), y=MSPE, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "MSPE", x="Number of time points")
Boxplot_MSPE_VAR_P_8_Time

ggsave("Boxplot_MSPE_VAR_P_8_Time.png", width = 6, height = 4)
...
```{r}
Boxplot_MSPE_VAR_P_8_Persons = ggplot(Performance.MSPE.Mean.P8, aes(x=as.factor(Persons), y=MSPE, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() +
labs(y = "MSPE", x="Number of persons")
Boxplot_MSPE_VAR_P_8_Persons

ggsave("Boxplot_MSPE_VAR_P_8_Persons.png", width = 6, height = 4)
...
```{r}
Boxplot_R2_VAR_P_8_Time = ggplot(Performance.R2.Mean.P8, aes(x=as.factor(Time), y=R2, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "R2", x="Number of time points")
Boxplot_R2_VAR_P_8_Time

ggsave("Boxplot_R2_VAR_P_8_Time.png", width = 6, height = 4)
```

##### Across the number of persons

```{r}
Boxplot_R2_VAR_P_8_Persons = ggplot(Performance.R2.Mean.P8, aes(x=as.factor(Persons), y=R2, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() +
labs(y = "R2", x="Number of persons")
Boxplot_R2_VAR_P_8_Persons

ggsave("Boxplot_R2_VAR_P_8_Persons.png", width = 6, height = 4)
```
...
```{r}
Boxplot_MSPE_VAR_Variables = ggplot(Performance.MSPE.Mean, aes(x=as.factor(Variables), y=MSPE, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw()+ 
labs(y = "MSPE", x="Number of variables")
Boxplot_MSPE_VAR_Variables

ggsave("Boxplot_MSPE_VAR_Variables.png", width = 6, height = 4)
...
```{r}
Boxplot_MSPE_VAR_Time = ggplot(Performance.MSPE.Mean, aes(x=as.factor(Time), y=MSPE, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(y = "MSPE",x="Number of time points")
Boxplot_MSPE_VAR_Time

ggsave("Boxplot_MSPE_VAR_Time.png", width = 6, height = 4)
...
```{r}
Boxplot_MSPE_VAR_Persons = ggplot(Performance.MSPE.Mean, aes(x=as.factor(Persons), y=MSPE, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() +
labs(y = "MSPE", x="Number of persons")
Boxplot_MSPE_VAR_Persons

ggsave("Boxplot_MSPE_VAR_Persons.png", width = 6, height = 4)
...
```{r}
Boxplot_R2_VAR_Variables = ggplot(Performance.R2.Mean, aes(x=as.factor(Variables), y=R2, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() + 
labs(x="Number of variables")
Boxplot_R2_VAR_Variables

ggsave("Boxplot_R2_VAR_Variables.png", width = 6, height = 4)
```

##### Across the number of time points

```{r}
Boxplot_R2_VAR_Time = ggplot(Performance.R2.Mean, aes(x=as.factor(Time), y=R2, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() +
labs(x="Number of time points")
Boxplot_R2_VAR_Time

ggsave("Boxplot_R2_VAR_Time.png", width = 6, height = 4)
```

##### Across the number of persons

```{r}
Boxplot_R2_VAR_Persons = ggplot(Performance.R2.Mean, aes(x=as.factor(Persons), y=R2, fill = Model)) + 
  geom_boxplot() + stat_summary(fun.y=mean, geom="point", shape=4, size=1) + facet_wrap(~Model) + scale_fill_grey() + theme_bw() +
labs(x="Number of persons")
Boxplot_R2_VAR_Persons

ggsave("Boxplot_R2_VAR_Persons.png", width = 6, height = 4)
```
