...
# Save Psi matrix
save(Psi.list, file = paste("Psi_Effect_",Eff[f],"_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_R_",r,".RData",sep = ""))
...
# Save datasets
save(Sim.Var.Data, file = paste("Data_Effect_",Eff[f],"_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))
}}
...
# Generate training and testing set for the true number of components
...
load(file = paste("Data_Effect_",Eff[f],"_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_R_",r,".RData",sep = ""))

# Generate training and testing set for the original data
data.list = data.block(Sim.Var.Data$data,fold)
save(data.list, file = paste("Data_Block_Effect_",Eff[f],"_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",Q[q],"_R_",r,".RData",sep = ""))

# Generate training and testing set for the components
data.list.PC = data.block.PC(data.list,nComp=Q[q],fold)
data.list.Raw = data.block.Raw(data.list,fold)

# Save datasets
save(data.list.PC, file = paste("Data_Block_PC_Effect_",Eff[f],"_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",Q[q],"_R_",r,".RData",sep = ""))
save(data.list.Raw, file = paste("Data_Block_Raw_Effect_",Eff[f],"_N_",N[n],"_T_",T[t],"_Q_",Q[q],"_E_",e,"_nComp_",Q[q],"_R_",r,".RData",sep = ""))
}}}}}}
